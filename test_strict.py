"""
Strict Test - unified inference using a scorer plus optimized EvoPrompt rules,
with transfer routing disabled (control rows). For the paper mainline with
transfer routing enabled, use test_universal.py.
...
Usage:
    # Prompt bank scorer
    python test_strict.py --scorer_type prompt_bank --dataset mvtec \
        --checkpoint_path ./my_exps/.../stage1_final.pth \
        --evo_rules_path ./my_exps/.../evo_prompt_cache.json

    # CLIP transfer scorer
    python test_strict.py --scorer_type clip_transfer --dataset visa \
        --evo_rules_path ./my_exps/.../evo_prompt_cache.json

    # Custom scorer
    python test_strict.py --scorer_type custom \
...
REMOVED_INTERFACE_FLAGS = {
    "--disable_role_fallback": "Not available in strict mode; use test_universal.py.",
    "--enable_semantic_fallback": "Not available in strict mode; use test_universal.py. Strict routing is class-name only.",
    "--semantic_fallback_template": "Not available in strict mode; use test_universal.py.",
    "--semantic_fallback_min_sim": "Not available in strict mode; use test_universal.py.",
    "--semantic_fallback_min_margin": "Not available in strict mode; use test_universal.py.",
    "--enable_template_transfer": "Not available in strict mode; use test_universal.py.",
    ...
    "--enable_safe_switch": "Not available in strict mode; use test_universal.py.",
    "--safe_switch_min_gain_cross": "Not available in strict mode; use test_universal.py.",
    "--safe_switch_min_gain_src": "Not available in strict mode; use test_universal.py.",
    "--safe_switch_max_score_std": "Not available in strict mode; use test_universal.py.",
    "--safe_switch_enable_mix": "Not available in strict mode; use test_universal.py.",
    "--safe_switch_mix_gain_cross": "Not available in strict mode; use test_universal.py.",
    "--safe_switch_mix_score_std": "Not available in strict mode; use test_universal.py.",
    "--safe_switch_mix_alpha_min": "Not available in strict mode; use test_universal.py.",
    "--safe_switch_mix_alpha_max": "Not available in strict mode; use test_universal.py.",
}
...
def _preflight_removed_flags_or_exit(argv: List[str]) -> None:
    ...
    raise SystemExit(
        "These flags are not accepted by the strict entrypoint `test_strict.py`.\n"
        f"{detail}\n"
        "For the paper's transfer routing, use test_universal.py; strict runs must drop these flags."
    )


def _active_entrypoint_profile() -> str:
    profile = str(os.environ.get("COEVOAD_TEST_ROUTE_PROFILE", "STRICT_MAINLINE")).strip().upper()
...
def run_universal_test(args, route_config: Optional[RouteRuntimeConfig] = None):
    ...
    logger = setup_logger(args.save_path, "log_optimized_universal.txt", "test_universal", file_mode="w")
