...
try:
    ...
    from pkg_resources import packaging as _packaging_mod
    _packaging_version = _packaging_mod.version
...
if _packaging_version.parse(torch.__version__) < _packaging_version.parse("1.7.1"):
